    ...
    fs.lstat(filePath, function (err, stat) {
        ...
        fs.readdir(dir, function (err, files) {
            ...
            async.map(
                ...
                , function (err, sizes) {
                    var totalSize = sizes && sizes.reduce(function (p, s) {
                            return p + s
                        }, size);
                    sizeCache[filePath] = totalSize;
...
var getCachedSize = function (filePath) {
...
module.exports.getCachedSize = getCachedSize;
